...
API_ID = int(environ['18168309'])
API_HASH = environ['57b2582f71b6fe3792c160e86a90b98c']
BOT_TOKEN = environ['5281516722:AAG6mlno94-aPCTggwX5DJsmcMmDnOX9TLU']

# Bot settings
CACHE_TIME = int(environ.get(180))
...
auth_channel = environ.get('-1001726306787')
auth_grp = environ.get('-1001726306787')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get("mongodb+srv://Saru2188:Saru2188@cluster0.l11up.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('Sarvarish')
COLLECTION_NAME = environ.get('Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('-100658384289'))
SUPPORT_CHAT = environ.get('@Saru2188')
